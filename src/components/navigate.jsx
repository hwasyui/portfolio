...
const Navigate = () => {
  ...
  return (
    <header
      className={`fixed top-0 inset-x-0 z-40 transition-[background-color,border-color,opacity,transform] duration-300 ${
                ...
                l.href ? (
                  ...
                  >
                    <Link
                      ...
                      className="block text-left py-2.5 text-[15px] font-medium text-zinc-700"
                    >
                      {l.label}
                    </Link>
                  </motion.div>
